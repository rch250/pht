...
if ((isset($_POST['myName'])) && empty($_POST['honeypot'])) {
    ...
    $mail->isSMTP();
    $mail->Host = 'mail.robertheintze.webhostingforstudents.com';
    $mail->Port = 587;

    $mail->SMTPAuth = true;
    //Use a fixed address in your own domain as the from address
    $mail->Username = "phpmailer@robertheintze.webhostingforstudents.com";
    $mail->Password = "Enter1234567890";




    $mail->setFrom('phpmailer@robertheintze.webhostingforstudents.com', 'Robert Heintze');
